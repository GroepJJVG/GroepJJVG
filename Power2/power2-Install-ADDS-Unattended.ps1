# power2-Install-ADDS-Unattended.ps1

# Start transcript for logging
Start-Transcript -Path "C:\power2-Install-ADDS-Unattended.log" -Append
...
try {
    ...
    Add-DnsServerPrimaryZone -NetworkID "$IPAddress/$PrefixLength" -ReplicationScope "Forest" -DynamicUpdate "Secure"
...
$postRestartScriptPath = "C:\Scripts\power2-Post-Restart-Config.ps1"
