# Post-Restart-Config.ps1

# Start transcript for logging
Start-Transcript -Path "C:\Windows\Setup\Scripts\Post-Restart-Config.log" -Append

Write-Host "Post-Restart-Config script started."
...
Write-Host "You can check C:\Scripts\Post-Restart-Config.log for execution details."
