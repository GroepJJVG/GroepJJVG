...
Start-Transcript -Path "C:\Windows\Setup\Scripts\Install-ADDS-Unattended.log" -Append
...
$postRestartScriptPath = "C:\Windows\Setup\Scripts\power1-Post-Restart-Config.ps1"
